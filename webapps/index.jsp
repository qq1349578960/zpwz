...
<html xmlns="http://www.w3.org/1999/xhtml">
 ...
 $.post("ajax.php", {type:"1"}, function(data) {
  ...
  <div class="nav"> 
   ...
   <div class="bs-module"> 
    <div class="menu-simple "> 
     <ul id="portalmenu"> 
      <li><a target="_self" href="index.html" class="current">首页</a> </li> 
   ...
   <div class="bs-module"> 
    <div class="customerimage-default "> 
     <div class="imgplace zx_imgplace"> 
      <a href="http://www.htmlsucai.com" target="_blank" class="cusimglink"><img src="images/104003_medias_2015630_2015630141029143.jpg" class="cusimg" /></a> 
     </div> 
    </div> 
   </div> 
  ...
  <div class="footer">
   <span> &copy;2015&nbsp;&nbsp;51talk&nbsp;&nbsp;京ICP备05051632号 京公网安备110108002767号 &nbsp;Powered by&nbsp;<a href="http://www.htmlsucai.com" class="footerlogo" target="_blank"></a> </span> 
  </div>  
  <script type="text/javascript">
        require([
